function [X, t, t_uutc] = import_sess(this, varargin)
    ...
    % Copyright 2020-2025 Richard J. Cui. Created: Thu 02/06/2020  3:40:19.634 PM
    % $Revision: 0.3 $  $Date: Wed 09/10/2025 12:41:59.177 PM $
    %
    ...
    fprintf('Importing session from %d channels... ', num_chan);
