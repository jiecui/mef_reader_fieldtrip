function seg_cont = analyzeContinuity(this, bid)
    ...
    % Copyright 2020-2025 Richard J. Cui. Created: Wed 02/05/2020 10:19:17.599 AM
    % $Revision: 0.6 $  $Date: Wed 09/10/2025 13:40:00.865 PM $
    %
    ...
    arguments
        bid (:, :) table = table % block index data
    end % optional
    ...
    x = find(abs(et - st) > 1);
    x = x(:); % make sure to get vertical vector
    ...
    for k = 1:num_chunk_cont
        bg_k = chunk_index(k, 1);
        ed_k = chunk_index(k, 2);
